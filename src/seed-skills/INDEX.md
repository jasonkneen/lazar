...
- _meta/health-check — full self-test: validates kernel locked, env vars, sandbox boundaries, auto-rotation, memory persistence, optional recursion, end-to-end TS+Python builds. Runs in temp workspace, cleans up, prints PASS/FAIL/SKIP summary.
